...
class RotaryEmbedding(torch.nn.Module):
    ...
    def cos_sin(
        ...
        # assert self.cos_cached is not None, f"cos_cached must be known and not None {self.seq_len_cached} {seq_len}"
        # print("self seq len:", self.seq_len_cached, "seq len:", seq_len)
